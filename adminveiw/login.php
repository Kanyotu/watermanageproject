...
<style>
  .contain{
    ...
    width: 40%;
    padding: 10px;
    box-shadow: 1px 5px 5px 5px rgba(0, 1, 1, 0.8);
    background-color: rgba(41, 166, 243, 0.8);
    border-radius: 10px;
  }
  .contain input{
    width: 70%;
...
<body>
    <form action="<?php htmlspecialchars($_SERVER['PHP_SELF']) ; ?>" method="post">
        <div class="contain">
          ...
          <a href="http://localhost:808\2ndyearsem2project\uservieiw\login.php" class="bbutton">customer</a>
          <a href="http://localhost:808\2ndyearsem2project\managervieiw\login.php" class="bbutton">manager</a>
          <a href="http://localhost:808\2ndyearsem2project\adminveiw\login.php" class="bbutton">admin</a>
          <a href="http://localhost:808\2ndyearsem2project\workerveiw\login.php" class="bbutton">worker</a>
        </div>
    </form>
